   ...
   public class ContrDB
    {
        ...
        public static void AddShopDB(Shop new_shop)
        {
            ShopContr.AddShop(new_shop, shops);
        }

        public static void DeleteShopDB(string shop_del)
        {
            ShopContr.DeleteShop(shop_del, shops);
        }
        ...
        public static void AddProductDB(string _shop_name, Product _new_prod)
        {
            ShopContr.AddProduct(_shop_name, _new_prod, shops);
        }

        //Метод удаления товара
        public static void DeleteProductDB(string _shop_name, int indx)
        {
            ShopContr.DeleteProduct(_shop_name, indx, shops);
